...
import com.cibertec.edu.Repository.CitasRepository;
...
public class CitasService {
    ...
    public Citas guardarCita(Citas cita) {
        // Validar paciente
        Pacientes paciente = pacientesRepository.findById(cita.getPaciente().getIdPaciente())
    ...
    public Pacientes obtenerPacientePorId(Integer idPaciente) {
        return pacientesRepository.findById(idPaciente).orElse(null);
    }
